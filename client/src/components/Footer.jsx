		...
		<Container as='footer' maxW='7xl'>
			...
			>
				<Stack spacing={{ base: "6", md: "8" }} align='start'>
					<Flex alignItems='center'>
						<Icon as={MdComputer} h='10' w='10' color={mode("black", "yellow.200")} />
						<Text fontSize='2xl' fontWeight='extrabold'>
							Bimtu Computers
						</Text>
					</Flex>
					<Text color='muted'>Best computer Offers!</Text>
				</Stack>
			...
			<Stack pt='8' pb='12' justify='space-between' direction={{ base: "column-reverse", md: "row" }} align='center'>
				<Text fontSize='sm' color='subtle'>
					&copy; {new Date().getFullYear()} Bimtu Computers and Accessories. All rights reserved.
				</Text>
